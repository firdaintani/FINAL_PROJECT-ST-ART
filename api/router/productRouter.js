...
const {getAllProduct, addProduct, deleteProduct,getProductList ,updateProduct,newArrival, getProductDetail, search, productDiscount}  = require('./../controller').productController
